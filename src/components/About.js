const About = () => {
  return (
        ...
        <div id="about"class="snap-start bg-[#00df9a] w-screen h-screen flex items-center justify-center text-8xl">
        <div className="w-full h-[80vh] short:h-full max-w-[900px] p-10 px-10 md:p-10 max-h-[600px]">
        <h1 className="font-bold mb-2 md:mb-5 text-3xl md:text-4xl lg:text-6xl" >About</h1>
        <hr className="border-[#ffffff] border-[4px] rounded w-12 mb-4 " />
              <div className="space-y-2 sm:space-y-3 text-[12px] md:space-y-5 sm:my-3 sm:text-sm lg:text-[16px] lg:leading-7 dark:text-stone-900">
...
<p className="p-3 bg-white rounded-md">Hello mate</p>
