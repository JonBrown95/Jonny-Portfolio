...
const Hero = () => {
  ...
  return (
    ...
    <div className="relative snap-start w-screen mx-auto h-full flex flex-col justify-center items-center text-center">
      

    <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl">Hello, I'm <span class="underline underline-offset-3 decoration-8 decoration-[#00df9a] ">Jonathan!</span></h1>
